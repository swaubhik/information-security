...
let plainText = 65;
console.log("Message before encryption: " + plainText);
console.log("Public Key: (" + e + ", " + n + ")");
console.log("Private Key: (" + d + ", " + n + ")");
let cipherText = rsaEncrypt(plainText, e, n);
console.log("Ciphertext : " + cipherText);
console.log("After Decryption : " + rsaDecrypt(cipherText, d, n));
